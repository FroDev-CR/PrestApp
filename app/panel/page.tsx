...
type View = "dashboard" | "loans" | "settings";
  ...
  return (
    <div className="app-shell">
      ...
      <main className="app-main">
        <Topbar profileOpen={profileOpen} setProfileOpen={setProfileOpen} goTo={goTo} onLogout={logout} />
      ...
      <BottomNav view={view} goTo={goTo} onNew={() => setNewLoanOpen(true)} />
...
function Topbar({ profileOpen, setProfileOpen, goTo, onLogout }: { profileOpen: boolean; setProfileOpen: (open: boolean) => void; goTo: (view: View) => void; onLogout: () => void }) {
  return (
        ...
        <div className="profile-wrap">
          ...
          {profileOpen && (
            <div className="profile-menu">
              ...
              <Link href="/admin"><ShieldCheck size={17} /> Panel administrador</Link>
              <div />
              <button onClick={onLogout}><ArrowLeft size={17} /> Cerrar sesión</button>
            </div>
          )}
        </div>
      </div>
